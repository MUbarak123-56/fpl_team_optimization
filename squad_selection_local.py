...
gk = team_df[team_df["position"] == "GK"].sort_values("total_points", ascending=False).head(1)
defense_list = team_df[team_df["position"] == "DEF"].sort_values("total_points", ascending=False).head(defense)
midfield_list = team_df[team_df["position"] == "MID"].sort_values("total_points", ascending=False).head(midfield)
attack_list = team_df[team_df["position"] == "FWD"].sort_values("total_points", ascending=False).head(forward)
